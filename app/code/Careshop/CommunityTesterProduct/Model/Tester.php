...
use Careshop\CommunityTesterProduct\Model\ResourceModel\Tester as TesterResource;
use Careshop\CommunityTesterProduct\Model\ResourceModel\Tester\Collection;
use Careshop\CommunityTesterProduct\Model\ResourceModel\Tester\CollectionFactory as TesterCollectionFactory;

class Tester extends AbstractModel
{
    /**
     * Cache tag
     *
     * @var string
     */
    const CACHE_TAG = 'community_tester';
     ...
     * @var string
     */
    protected $_cacheTag = 'community_tester';
     ...
     * @var string
     */
    protected $_eventPrefix = 'community_tester';
    ...
    public function __construct(
        ...
        Registry $registry,
        DateTime $dateTime,
        TesterCollectionFactory $testerCollectionFactory,
        ProductCollectionFactory $productCollectionFactory,
        AbstractResource $resource = null,
        AbstractDb $resourceCollection = null,
        array $data = []
    ) {
        $this->testerCollectionFactory     = $testerCollectionFactory;
    ...
    {
        $this->_init(TesterResource::class);
    }
