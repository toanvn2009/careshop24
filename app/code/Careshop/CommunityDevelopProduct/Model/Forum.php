...
use Careshop\CommunityDevelopProduct\Model\ResourceModel\Forum as ForumResource;
use Careshop\CommunityDevelopProduct\Model\ResourceModel\Forum\Collection;
use Careshop\CommunityDevelopProduct\Model\ResourceModel\Forum\CollectionFactory as ForumCollectionFactory;
...
class Forum extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'community_develop_forum';
     ...
     * @var string
     */
    protected $_cacheTag = 'community_develop_forum';
     ...
     * @var string
     */
    protected $_eventPrefix = 'community_develop_forum';
    ...
    public function __construct(
        ...
        Registry $registry,
        DateTime $dateTime,
        ForumCollectionFactory $forumCollectionFactory,
        ProductCollectionFactory $productCollectionFactory,
        AbstractResource $resource = null,
        AbstractDb $resourceCollection = null,
        array $data = []
    ) {
        $this->forumCollectionFactory     = $forumCollectionFactory;
    ...
    {
        $this->_init(ForumResource::class);
    }
