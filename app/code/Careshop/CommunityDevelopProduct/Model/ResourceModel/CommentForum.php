...
use Careshop\CommunityDevelopProduct\Model\CommentForum as CommentForumModel;

class CommentForum extends AbstractDb 
{
    /**
     * Date model
     *
    ...
    {
        $this->_init('community_develop_comment_forum', 'entity_id'); 
    }
