...
use Careshop\CommunityDevelopProduct\Model\ReportForum as ReportForumModel;

class ReportForum extends AbstractDb 
{
    /**
     * Date model
     *
    ...
    {
        $this->_init('community_develop_report_forum', 'entity_id'); 
    }
