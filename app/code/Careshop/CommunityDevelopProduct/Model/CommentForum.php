...
use Careshop\CommunityDevelopProduct\Model\ResourceModel\CommentForum as CommentForumResource;
use Careshop\CommunityDevelopProduct\Model\ResourceModel\CommentForum\Collection;
use Careshop\CommunityDevelopProduct\Model\ResourceModel\CommentForum\CollectionFactory as CommentForumCollectionFactory;

class CommentForum extends AbstractModel 
{
    /**
     * Cache tag
     *
     * @var string
     */
    const CACHE_TAG = 'community_develop_comment_forum';
    ...
    public function __construct(
        ...
        Registry $registry,
        DateTime $dateTime,
        CommentForumCollectionFactory $commentForumCollectionFactory,
        ProductCollectionFactory $productCollectionFactory,
        AbstractResource $resource = null,
        AbstractDb $resourceCollection = null,
        array $data = []
    ) {
        $this->commentForumCollectionFactory     = $commentForumCollectionFactory;
    ...
    {
        $this->_init(CommentForumResource::class);
    }
     ...
     * @return Collection
     */
    public function getForumDevelop($develop_id = null)
    {
