...
use Careshop\CommunityDevelopProduct\Block\Adminhtml\Forum\Edit\Tab\Renderer\CommentForum\Action;
use Careshop\CommunityDevelopProduct\Block\Adminhtml\Forum\Edit\Tab\Renderer\CommentForum\Customer;


class ForumComment extends Extended implements TabInterface
{
    ...
    {
        return $this->getUrl('*/*/commentGrid', ['id' => $this->getDevelopForum()->getId()]);
    }
    ...
    {
        return __('Edit Develop Forum Comment');
    }
    ...
    {
        return $this->getUrl('communitydevelop/forum/comment', ['_current' => true]);
    }
