...
namespace Careshop\CommunityIdea\Model\ResourceModel\Category;
...
use Careshop\CommunityIdea\Model\ResourceModel\Category;
...
class Tree extends Dbp
{
    ...
    /**
     * Community Category Resource instance
     *
     * @var Category
     */
    ...
    /**
     * Inactive Community Category Ids
     *
     * @var array
     */
    ...
    public function __construct(
        ...
        parent::__construct(
            $coreResource->getConnection('community_write'),
            $coreResource->getTableName('community_category'),
            [
    ...
    public function initInactiveCategoryIds()
    {
        ...
        $this->eventManager->dispatch('community_category_tree_init_inactive_category_ids', ['tree' => $this]);
    ...
    /**
     * Retrieve inactive Community Category item ids
     *
     * @return array
     */
    ...
    /**
     * Check is Community Category items active
     *
     * @return bool
     */
    ...
    /**
     * Load whole Community Category tree, that will include specified Categories ids.
     *
     * @param array $ids
    ...
    /**
     * Get real existing Community Category ids by specified ids
     *
     * @param array $ids
     *
     * @return array
