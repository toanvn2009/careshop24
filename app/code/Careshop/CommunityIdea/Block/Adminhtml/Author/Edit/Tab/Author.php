...
use Careshop\CommunityIdea\Block\Adminhtml\Renderer\Image;
use Careshop\CommunityIdea\Helper\Data;
use Careshop\CommunityIdea\Helper\Image as ImageHelper;
...
class Author extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $author = $this->_coreRegistry->registry('community_author');
        ...
        if ($this->checkCustomerId($author->getCustomerId())) {
            ...
            $fieldset->addField('customer', 'text', [
                ...
                <script type="text/x-magento-init">
                    {
                        "#author_customer": {
                            "Careshop_CommunityIdea/js/view/author":{
                                "url": "' . $this->getAjaxUrl() . '"
                            }
                        }
                    }
    ...
    {
        return $this->getUrl('community/author/customergrid');
    }
}
