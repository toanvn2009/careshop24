...
class Topic extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $topic = $this->_coreRegistry->registry('community_topic');
        ...
        if (!$topic->getId()) {
            $topic->addData([
                'meta_title' => $this->_scopeConfig->getValue('community/seo/meta_title'),
                'meta_description' => $this->_scopeConfig->getValue('community/seo/meta_description'),
                'meta_keywords' => $this->_scopeConfig->getValue('community/seo/meta_keywords'),
                'meta_robots' => $this->_scopeConfig->getValue('community/seo/meta_robots'),
            ]);
        }
