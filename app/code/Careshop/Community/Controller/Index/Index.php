<?php
namespace Careshop\Community\Controller\Index;
...
class Index extends Action implements HttpGetActionInterface, HttpPostActionInterface
{
    ...
    {  
        $pageId = $this->scopeConfig->getValue(\Careshop\Community\Helper\Page::XML_PATH_HOME_PAGE_COMMUNITY, ScopeInterface::SCOPE_STORE);
        $resultPage = $this->page->prepareResultPage($this, $pageId);
        if (!$resultPage) {
            /** @var Forward $resultForward */
            $resultForward = $this->resultForwardFactory->create();
            $resultForward->forward('cms/index/defaultIndex');
