...
return [
    'modules' => [
        ...
        'Careshop_Community' => 1,
        'Careshop_CommunityCustomer' => 1,
        'Careshop_CommunityDevelopProduct' => 1,
        'Careshop_CommunityIdea' => 1,
        'Careshop_CommunityTalentProduct' => 1,
        'Careshop_CommunityTesterProduct' => 1,
        'Careshop_MagefanBlog' => 1,
        'Careshop_RokanthemesBrand' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Eadesigndev_Mobiledetect' => 0,
        'Klarna_Core' => 1,
        ...
        'Rokanthemes_BoughtViewed' => 1,
        'Rokanthemes_Brand' => 1,
        'Rokanthemes_Customaddress' => 1,
        'Rokanthemes_Customcustomer' => 1,
        'Rokanthemes_Instagram' => 1,
        'Rokanthemes_Newproduct' => 1,
        'Rokanthemes_Notifications' => 1,
        'Rokanthemes_Repair' => 1,
        'Rokanthemes_ReturnsWarranty' => 1,
        'Rokanthemes_Reviews' => 1,
        'Rokanthemes_Rewards' => 1,
